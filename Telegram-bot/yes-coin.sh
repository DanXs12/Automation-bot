...
echo "Showing AAI header..."
wget -O loader.sh https://raw.githubusercontent.com/DanXs12/Automation-bot/main/loader.sh && chmod +x loader.sh && ./loader.sh
curl -s https://raw.githubusercontent.com/DanXs12/Automation-bot/main/logo.sh | bash
sleep 2
